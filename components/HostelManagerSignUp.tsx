    ...
    <div className="min-h-screen flex flex-col w-full md:flex-row">
      ...
      <div className="flex-1 flex flex-col justify-center items-center bg-[#F9FBFF] px-6 py-12">
        <div className="w-full max-w-md bg-white rounded-2xl shadow-2xl p-8">
          <h2 className="text-3xl font-mono font-extrabold mb-6 text-[#0B1E3F] text-center">Hostel Manager Sign Up</h2>
          ...
          <form className="space-y-4" onSubmit={handleSignUp}>
            ...
            <div>
              <label className="block text-[#0B1E3F] text-sm font-mono font-semibold mb-2" htmlFor="phone">
                Phone Number
              </label>
              <input
                className="appearance-none border border-[#E5E8EC] rounded-lg w-full py-3 px-4 text-[#1E1E2F] bg-[#F9FBFF] placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-[#007BFF] focus:border-transparent transition font-mono"
            ...
            <div>
              <label className="block text-[#0B1E3F] text-sm font-mono font-semibold mb-2" htmlFor="businessName">
          ...
          <div className="mt-6 text-center">
            <p className="text-gray-600 text-sm font-mono">
              ...
              <a href="/forhostelowners" className="text-[#007BFF] hover:text-[#0B1E3F] font-semibold transition">
                Sign in here
              </a>
            </p>
          </div>
...
export default HostelManagerSignUp;
